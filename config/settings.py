...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=1), #ACCESS_TOKEN - bu uning yashash vaqti bu 1 minutdan 5 minutgacha yashash vaqti
    "REFRESH_TOKEN_LIFETIME": timedelta(days=7), #REFRESH_TOKEN - bu uning yashash vaqti bu 1 kundan 1 oygacha yashash vaqti
    "ROTATE_REFRESH_TOKENS": False,
    "BLACKLIST_AFTER_ROTATION": False,
    "UPDATE_LAST_LOGIN": False,

    "ALGORITHM": "HS256", # algoritm shifravaniya
